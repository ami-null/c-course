...
\begin{document}
    ...
    \begin{frame}{Introduction to Functions in C}
        \begin{itemize}
            ...
            \item The \textttbg{main()} function is the entry point to every C program
        \end{itemize}
    \end{frame}
...
int square(int n) {
    return n * n;
        ...
        \begin{itemize}
            ...
            \item The return value can be assigned to a variable: \mintinline{c}|int s = square(5);|
            \item The return value can also be passed as an argument to another function: \mintinline{c}|printf("%d", square(10));|
            \item Without return values, the above two line would not be possible
        \end{itemize}
    \end{frame}
...
sum = add(4, 6);     // multiple parameters
    ...
    \begin{frame}{Types of Functions}
        \begin{itemize}
            \item Library functions - predefined in header files like \textttbg{printf()}, \textttbg{scanf()}, \textttbg{sqrt()}
    ...
    \begin{frame}{Example: Function with No Parameters and No Return Value}
        ...
        When a function returns no value, its return type is \textttbg{void}.
    \end{frame}
    ...
    \begin{frame}{Example: Function with One Parameter and a Return Value}
        ...
        Since this function returns an integer value, its return type is \textttbg{int}.
    \end{frame}
...
%             \item If \textttbg{main()} calls a function defined later, the compiler has no information about that function
...
%     \end{frame}
    ...
    \begin{frame}{Introduction}
        \begin{itemize}
            ...
            \item Header files (files with \textttbg{.h} extension) help reuse function/constant definition across multiple C files
            \item Header files have no \textttbg{main()} function
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Example Header File}
        ...
        Save this file as \textttbg{utils.h} (you can use any name you want).
    \end{frame}
