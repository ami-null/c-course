...
\begin{document}
    ...
    \begin{frame}{Control Flow and Structure of a Program}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Selection or conditional execution: exceuting a codeblock if certain conditions are met (if-else statement)
                \item Iteration or loop: repeatedly executing a block of code or commands while a certain condition is true, stop the loop if the codition is no longer true
            \end{itemize}
    ...
    \begin{frame}{Iteration or Loops}
        \begin{itemize}
            ...
            \item \textbf{WHILE loop}: repeatedly execute while condition is true. Usually, the number of iteration required until the condition becomes false, is not in known advanced
    ...
    \begin{frame}{Break and Continue}
        \begin{itemize}
            \item \textbf{BREAK}: exit a loop immediately without ant further iteration. When inside nested loops, it exits out of the loop in which the \textbf{BREAK} statement is called
            \item \textbf{CONTINUE}: skip the rest of current iteration, proceed to the next iteration
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Before Designing an Algorithm}
        ...
        \begin{itemize}
            ...
            \item \textbf{Outputs}: What results should be produced, and in what form?
            ...
            \item \textbf{Repetition}: Are loops required, and should the output be produced once or repeatedly?
    ...
    \begin{frame}{Conventions}
        \begin{itemize}
            ...
            \item Keywords like Input, If, While, For, Output
