...
30
    ...
    \begin{frame}[fragile]{Example: Take User Input Into an Array}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
    ...
    \begin{frame}[fragile]{Example: Summing the Elements of an Array}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
...
int mat3[2][3] = {1,2,3,4,5,6};
    ...
    \begin{frame}[fragile]{Example: Accessing Values in 2D Arrays}
        \begin{itemize}
    ...
    \begin{frame}[fragile]{Example: Input and Print a 2D Array}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
    ...
    \begin{frame}[fragile]{Example: Input and Print a 2D Array (cont.)}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
...
char s3[6] = {'H','i','!','\0'}; // explicit
    ...
    \begin{frame}[fragile]{Example: Comparing Two Strings: \texttt{strcmp()}}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
