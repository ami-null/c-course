...
int mat3[2][3] = {1,2,3,4,5,6};
    ...
    \begin{frame}[fragile]{Input and Print a 2D Array (cont.)}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
...
char s3[6] = {'H','i','!','\0'}; // explicit
    ...
    \begin{frame}{String Input Using \texttt{scanf()}}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
    ...
    \begin{frame}{String Input Using \texttt{fgets()}}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
    ...
    \begin{frame}{String Input Using \texttt{fgets()} (cont.)}
        \inputminted[
            frame=none,
            bgcolor=gray!20,
            linenos, 
