...
\begin{document}
    ...
    \begin{frame}{Formatted Output: \texttt{printf()}}
        \begin{itemize}
            ...
            \item A single \textttbg{printf()} call can have multiple format specifiers to print the values of multiple variables: \textttbg{printf("\%d \%d", x, y);}
        \end{itemize}
    \end{frame}


    \begin{frame}{Formatted Input: \texttt{scanf()}}
        \begin{itemize}
    ...
    \begin{frame}{Why use the ampersand sign (\&) in \texttt{scanf()}?}
        \begin{itemize}
