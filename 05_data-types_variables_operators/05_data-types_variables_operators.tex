...
\begin{document}
    ...
    \begin{frame}{Operators in C}
        \begin{itemize}
            ...
            \item \textbf{Increment or decrement:} \textttbg{++}, \textttbg{--}
                ...
                \begin{itemize}
                    ...
                    \item Example: 
                        \begin{itemize}
                            ...
                            \item \textttbg{int y = ++x;} \hfill \emph{(\textttbg{x=6}, \textttbg{y=6})}
                        \end{itemize}
                \end{itemize}
            \item \textbf{Postfix form} (\textttbg{x++}, \textttbg{x--})
                \begin{itemize}
                    ...
                    \item Example: 
                        \begin{itemize}
                            \item \textttbg{int x = 5;}
                            \item \textttbg{int y = x++;} \hfill \emph{(\textttbg{x=6}, \textttbg{y=5})}
                        \end{itemize}
                \end{itemize}
    ...
    \begin{frame}{Formatted Output: printf()}
        \begin{itemize}
            ...
            \item General form: \textttbg{printf("format string", values);}
