...
\begin{document}
    ...
    \begin{frame}{Semicolons and Statements}
        \begin{itemize}
            ...
            \begin{itemize}
                \item \mintinline{C}|int x = 10; int y = x + 5;|
...
// a multiline comment
    ...
    \begin{frame}[fragile]{Whitespace and Indentation}
        \begin{itemize}
            \item Whitespace is ignored (except in texts inside quotation marks)
...
if(condition){
    ...
    \begin{frame}{Coding Conventions}
        \begin{itemize}
            \item Meaningful variable names that represents the purpose and use of the variable
