...
\begin{document}
    ...
    \begin{frame}{Ingredients (cont.)}
        ...
        \begin{itemize}
            ...
            \item Debugging
            \item Version control interface
        \end{itemize}
    ...
    \begin{frame}{Crossplatform IDEs and Code Editors}
        \begin{itemize}
            \item Codeblocks
            \item Visual Studio Code (requires seperate C extension)
            \item Clion (free for non-commercial use only, student license available)
            \item Eclipse IDE
        \end{itemize}
    \end{frame}
